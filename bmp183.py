...
class bmp183():
        ...
        def __init__(self):
                ...
                self.SCK = spi_sck  #23 14 GPIO for SCK, other name SCLK
                self.SDO = spi_sdo  #21 13 GPIO for SDO, other name MISO
                self.SDI = spi_sdi  #19 12 GPIO for SDI, other name MOSI
                self.CS = spi_cs  #24 10 GPIO for CS, other name CE
